...
train_data = Cifar10Dataset('train', transform_train, target_transform, _noise_type='uniform', _noisy_ratio=ratio)
print('size of train_data:{}'.format(train_data.__len__()))

test_data = Cifar10Dataset('test', transform, target_transform)
